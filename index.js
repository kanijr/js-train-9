...
function findElementGreaterThan(arr, num) {
  ...
  return !Array.isArray(arr) ? undefined : arr.find((elem) => elem > num);
}
...
function findIndexByProperty(arr, name) {
  ...
  return !Array.isArray(arr)
    ? -1
    : arr.findIndex(({ name: userName }) => userName === name);
}
...
function findLastEvenNumber(arr) {
  ...
  return !Array.isArray(arr)
    ...
    : arr.findLast((elem) => elem % 2 === 0) || "Парних чисел не знайдено";
}
...
function getPositiveArrayValues(arr) {
  ...
  return !Array.isArray(arr)
    ? "Вхідний параметр має бути масивом"
    : Array.from(arr.values()).filter((elem) => elem > 0);
}
...
function removeAndDouble(arr, startIdx) {
  ...
  return !Array.isArray(arr)
    ? "Вхідний параметр має бути масивом"
    : arr.splice(startIdx) && arr.map((elem) => elem * 2);
}
...
function sumAndPrint(arr) {
  ...
  return !Array.isArray(arr)
    ...
    : arr.forEach((elem) => console.log(elem) || elem) ||
        arr.reduce((res, elemnt) => (res += elemnt));
}
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  return !Array.isArray(arr)
    ? "Вхідний параметр має бути масивом"
    : arr.slice(arr.length - n).forEach((elem) => console.log(elem) || elem) ||
        arr.reduceRight((res, elem) => (res += elem));
}
...
function insertElementAt(arr, index, element) {
  ...
  return !Array.isArray(arr)
    ? "Вхідний параметр має бути масивом"
    : arr.splice(index, 0, element) && arr;
}
...
function expandArrayByN(arr, n) {
  ...
  return (
    ((Array.isArray(arr) && typeof n === "number") ||
      "Перший вхідний параметр має бути масивом, другий - числом") &&
...
function findLongestWord(arr) {
  ...
  return !Array.isArray(arr)
    ? ""
    : arr.reduce((res, elem) => (res.length < elem.length ? elem : res));
}
...
function findDuplicateElements(arr) {
  ...
  return !Array.isArray(arr)
    ...
    : arr.filter(
        (elem, index) =>
          arr.indexOf(elem, index + 1) !== index &&
          arr.indexOf(elem, index + 1) !== -1
      );
}
...
function capitalizeWords(arr) {
  ...
  return !Array.isArray(arr)
    ? []
    : arr.map((elem) => elem[0].toUpperCase() + elem.slice(1, elem.length));
}
...
function calculateTotalPrice(arr) {
  ...
  return !Array.isArray(arr)
    ? 0
    : arr.reduce((res, { price }) => res + price, 0);
}
...
function findLastNegativeNumberIndex(arr) {
  ...
  return !Array.isArray(arr) ? -1 : arr.findLastIndex((elem) => elem < 0);
}
